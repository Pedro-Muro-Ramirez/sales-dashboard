...
const Signup = () => {
  // Get the sign-up function from auth context
  const { signUpNewUser } = useAuth();

  // Used to redirect the user after successful sign-up
  const navigate = useNavigate();

  // Handles form submission state, errors, and async logic
  const [error, submitAction, isPending] = useActionState(
    async (previousState, formData) => {
      // Extract form values from the submitted form
      ...
      // Return an error object to display validation feedback
      if (signUpError) {
